                ...
                html.Div([
                    ...
                    dash_table.DataTable(
                        ...
                        columns=[
                            ...
                            {'name': 'Average Profit', 'id': 'avg_profit', 'type': 'numeric', 'format': {'specifier': '.2f'}},
                        ],
                        data=[],
                        page_size=10,
                        virtualization=False,
                        style_table={'overflowX': 'auto', 'overflowY': 'visible', 'borderRadius': '12px', 'boxShadow': '0 4px 15px rgba(0, 0, 0, 0.1)'},
                        ...
                        style_cell_conditional=[
                            {'if': {'column_id': 'agent_name'}, 'width': '18%', 'fontWeight': 'bold'},
                            {'if': {'column_id': 'extra_kwargs'}, 'width': '48%'},
                            {'if': {'column_id': 'normalized_polling_rate'}, 'width': '12%'},
                            {'if': {'column_id': 'num_games'}, 'width': '10%'},
                            {'if': {'column_id': 'avg_profit'}, 'width': '12%'},
                        ]
                    ),
                ], className="section"),
