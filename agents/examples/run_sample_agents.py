...
AGENTS: List[Tuple[str, str, Dict[str, Any]]] = [
    ("fundamentalist", "Fundamentalist", {"aggression": 0.5, "buy_ratio": 1.2}),
    ("noise_trader", "NoiseTrader", {"aggression": 0.6, "default_val": 5}),
    ("noise_trader", "NoiseTrader", {"aggression": 0.6, "default_val": 7}),
    ("noise_trader", "NoiseTrader", {"aggression": 0.6, "default_val": 9}),
    ("noise_trader", "NoiseTrader", {"aggression": 0.6, "default_val": 11})
]
...
if __name__ == '__main__':
    ...
    run_game(AGENTS, SERVER_URL, EXPERIMENT_ID, POLLING_RATE)
